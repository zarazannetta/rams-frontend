...
<head>
    ...
    <title>Kartu Bangunan Pendukung (Kawasan Kantor)</title>
    <style>
        body {
...
<body>
    <div class="title">
        ...
        <div class="title-center">
            <h2>KARTU BANGUNAN PENDUKUNG<br />(KAWASAN KANTOR)</h2>
        </div>
        <div class="title-right">
            <h2>DEPAN</h2>
            <h2>LEMBAR DISTRIBUSI KE ----</h2>
            <h2>
                NOMOR LEMBAR KARTU BANGUNAN PENDUKUNG (KAWASAN KANTOR) --- -- --- -
            </h2>
        </div>
    </div>
    ...
    <div style="clear: both;"></div>
        ...
        <section class="section-left">
            ...
            <table class="header-table">
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">1. KANTOR OPERASIONAL</td>
                    <td>---</td>
                    <td>---</td>
                    <td>---</td>
                    <td>---</td>   
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">2. KANTOR BUJT</td>
                    <td>---</td>
                    <td>---</td>
                    <td>---</td>
                    <td>---</td>   
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">3. RUMAH DINAS</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">4. CAFETARIA/KANTIN</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">5. TEMPAT IBADAH</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">6. PENGOLAHAN LIMBAH</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">7. RUMAH GENSET</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">8. GUDANG</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">9. POS KEAMANAN</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">10. LAPANGAN/GEDUNG OLAHRAGA</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
                ...
                <tr>
                    <td style="border-right: 0.1px solid black;">11. AREA PARKIR</td>
                    <td>
                        ---
                    </td>
                    <td>---</td>
